...
namespace md5 {
	...
	void ostream::decode_buffer(unsigned x[16]) {
	...
	void ostream::add_to_hash(unsigned char ch) {
	...
	void ostream::finish(unsigned char digest[16]) {
